...
namespace Handelabra.Sentinels.UnitTest
{
    public class BaseTest
    {
        ...
        protected virtual IEnumerator MakeDecisions(IDecision decision)
        {
			...
			{
				ClassicAssert.Fail("MakeDecisions was forcing fast coroutines!");
			}
            ...
            if (!decision.Completed)
            {
				if (this.DecisionAutoDecide.HasValue && decision.SelectionType == this.DecisionAutoDecide)
                {
                    ...
                    {
						ClassicAssert.Fail("Test wanted to auto-decide for this decision, but the decision does not allow it: " + decision);
                    }
                }
                ...
                if (decision is SelectCardDecision)
                {
                    ...
                    {
                        ClassicAssert.Fail("This test presented a decision with only 1 choice, and it was not optional.");
                    }
                ...
                else if (decision is SelectLocationDecision)
                {
                    ...
                    else if (this.DecisionSelectLocation.Location != null)
                    {
                        ...
                        {
                            ClassicAssert.Fail("The selected location was not a choice: {0}" + this.DecisionSelectLocation);
                        }
                        else
                        {
                ...
                else if (decision is SelectCardsDecision)
                {
                    ...
                    {
                        ClassicAssert.Fail("A SelectCardsDecision may not be both optional and allow for auto-decisions.");
                    }
                ...
                else if (decision is SelectTurnTakerDecision)
                {
                    ...
                    {
                        ClassicAssert.Fail("The test selected " + selectTurnTaker.SelectedTurnTaker.Name + ", which is not one of the options: " + selectTurnTaker.Choices.Select(tt => tt.Name).ToCommaList());
                    }
                }
                ...
                else if (decision is SelectWordDecision)
                {
                    ...
                    if(this.DecisionSelectWords != null)
                    {
                        ...
                        {
                            ClassicAssert.Fail("The SelectWordDecision does not contain the word: " + word);
                        }
                    ...
                    else if (this.DecisionSelectWord != null)
                    {
                        ...
                        {
                            ClassicAssert.Fail("The SelectWordDecision does not contain the word: " + this.DecisionSelectWord);
                        }
                    ...
                    else if (this.DecisionSelectWordSkip)
                    {
                        ...
                        {
                            ClassicAssert.Fail("The SelectWordDecision is not optional so cannot be skipped.");
                        }
                ...
                else if (decision is SelectFromBoxDecision)
                {
                        ...
                        && this.DecisionSelectFromBoxIndex < this.DecisionSelectFromBoxIdentifiers.Count())
                    {
                        ...
                        {
                            ClassicAssert.Fail("The SelectFromBoxDecision does not allow the identifier: " + identifier);
                        }
                ...
                else if (decision is SelectTurnPhaseDecision)
                {
                    ...
                    if (this.DecisionSelectTurnPhase != null)
                    {
                        ...
                        {
                            ClassicAssert.Fail("The SelectTurnPhaseDecision does not contain the phase: " + this.DecisionSelectTurnPhase);
                        }
        ...
        public IEnumerator ReceiveMessage(MessageAction message)
        {
            ...
            else if (message.ShowCardSource)
            {
                ...
                else
                {
                    ...
                    ClassicAssert.Fail("Attempted to show null CardSource for message: " + msg);
                }
            }
        ...
        private void GoToPhase(TurnTakerController ttc, Phase phase)
        {
            ...
            {
                ClassicAssert.Fail("Tried to go to PlayCard phase while no more playable cards are in the player's hand.");
            }
            ...
            do
            {
                ...
                if (sanity < 0)
                {
                    ClassicAssert.Fail("Sanity check failed in GoToPhase");
                }
        ...
        protected Card GetCard(string identifier, int index = 0, Func<Card, bool> criteria = null)
        {
            ...
            if (result == null)
            {
                ClassicAssert.Fail("Tried to get card by identifer: " + identifier + " but could not make a card instance.");
            }
        ...
        protected Card GetCardInPlay(string identifier, int index = 0)
        {
            ...
            if (cards.Count() == 0)
            {
                ClassicAssert.Fail("There are no cards with identifier \"" + identifier + "\" in play.");
            }
        ...
        protected Card GetRandomCardFromHand(HeroTurnTakerController hero)
        {
            ...
            {
                ClassicAssert.Fail(hero.Name + " has no cards in hand to choose from.");
                return null;
            }
        }
        ...
        protected void PlayCardFromHand(HeroTurnTakerController hero, string identifier)
        {
            ...
            {
                ClassicAssert.Fail("Could not find card in " + hero.Name + "'s hand: " + identifier);
            }
        }
        ...
        protected Card MoveIntoPlay(TurnTakerController ttc, Card card, TurnTaker whosePlayArea, CardSource cardSource = null)
        {
            ...
            {
                ClassicAssert.Fail("Tried to move a null card into play.");
            }
            return card;
        }
        ...
        protected Card MoveCard(TurnTakerController ttc, Card card, Location location, bool toBottom = false, bool playIfPlayArea = true, bool overrideIndestructible = false, CardSource cardSource = null)
        {
            ...
            {
                ClassicAssert.Fail("Tried to move a null card.");
            }
            return card;
        }
        ...
        protected void UsePower(string identifier, int powerIndex = 0)
        {
            ...
            {
                ClassicAssert.Fail("Attempted to use a power from a card not in play");
            }
        }
        ...
        protected void AssertHitPoints(Card card, int expected)
        {
            ...
            {
                ClassicAssert.Fail(card.Identifier + " is not a target!");
            }
        }
        ...
        protected void QuickHPStorage(params Card[] cards)
        {
            ...
            foreach (var card in cards)
            {
				...
				{
					ClassicAssert.Fail ("Card after " + previous.Title + " in QuickHPStorage is null.");
				}
				else
				{
					ClassicAssert.Fail("First card in QuickHPStorage is null.");
				}
            }
        }
        ...
        protected void QuickHPCheck(params int?[] hpChange)
        {
            ...
            for (int i = 0; i < hpChange.Count(); i++)
            {
                ...
                if (changeHP.HasValue)
                {
                    ...
                    {
                        ClassicAssert.Fail("QuickHPCheck: " + card.Title + " isn't a target!");
                    }
                }
        ...
        protected void AssertGameOver(EndingResult? expectedResult = null)
        {
            ...
            if (expectedResult.HasValue)
            {
                ...
                {
                    ClassicAssert.Fail("GameController didn't have a GameOverEndingResult!");
                }
            }
        }
        ...
        protected void AssertInHand(Card card)
        {
            ...
            {
                ClassicAssert.Fail("Asserting that " + card.Title + " is in a hero's hand, but it is not a hero card!");
            }
        }
        ...
        protected void AssertRecordedDecisionAnswer(string decisionIdentifier, int? answerIndex, bool? skipped, bool? autodecided)
        {
            ...
            if (entries.Count() == 0)
            {
                ClassicAssert.Fail("No entry for decision identifier " + decisionIdentifier + " found in journal!");
            }
            else if (entries.Count() > 1)
            {
                ClassicAssert.Fail("Multiple entries for decision identifier " + decisionIdentifier + " found in journal!");
            }
            else
            {
            ...
            GameControllerDecisionEvent decider = decision =>
                {
                    ...
                    {
                        ClassicAssert.Fail("No decision of selection type " + selectionTypeThatShouldNotShowUp + " was expected to be present, but there was a decision: " + decision.ToStringForMultiplayerDebugging());
                    }
            ...
            for (int i = 0; i < result.OrderedGameActions.Count(); i++)
            {
                ...
                for (int j = 0; j < result.OrderedGameActions.Count(); j++)
                {
                    if (i != j)
                    {
                        ...
                        {
                            ClassicAssert.Fail("Duplicate game actions detected: " + thisAction.CardSource.Card);
                        }
                    }
                }
            }
        ...
        protected GameControllerMessageEvent AssertNextMessages(string[] expectedMessages, GameControllerMessageEvent oldReceiver = null)
        {
            ...
            GameControllerMessageEvent receiver = (message) => 
            {
                ...
                {
                    ClassicAssert.Fail("There are more messages than expected.");
                }
        ...
        protected GameControllerMessageEvent AssertNoMessage(GameControllerMessageEvent oldReceiver = null)
        {
            ...
            GameControllerMessageEvent receiver = (message) => 
                {
                    RunCoroutine(this.ReceiveMessage(message));
                    ClassicAssert.Fail("No message was expected, but there was one: '" + message.Message + "'");
                    return DoNothing();
                };
        ...
        protected void AssertPromoCardNotUnlocked(string identifier)
        {
            ...
            {
                ClassicAssert.Fail("Promo card '" + identifier + "' should not yet be unlocked.");
            }
        }
        ...
        protected void AssertPromoCardIsUnlockableThisGame(string identifier)
        {
            ...
            {
                ClassicAssert.Fail("Promo card '" + identifier + "' is not unlockable this game.");
            }
        }
        ...
        protected void AssertPromoCardIsNotUnlockableThisGame(string identifier)
        {
            if (DeckDefinition.AvailablePromos.Contains(identifier) && this.GameController.IsPromoCardUnlockableThisGame(identifier))
            {
                ClassicAssert.Fail("Promo card '" + identifier + "' is unlockable this game.");
            }
        }
        ...
        protected void AssertPromoCardUnlocked(string identifier)
        {
            if (DeckDefinition.AvailablePromos.Contains(identifier) && !this.GameController.IsPromoCardUnlocked(identifier))
            {
                ClassicAssert.Fail("Promo card '" + identifier + "' should be unlocked.");
            }
        }
        ...
        public static Game LoadGamePath(string path)
        {
            ...
            {
                ClassicAssert.Fail("Data file not found: " + path);
                return null;
            }
        }
		...
		private IEnumerator WillPerformAction(GameAction gameAction)
		{
            ...
            {
                ClassicAssert.Fail("Tried to make a decision with FastCoroutines in Pretend mode");
            }
